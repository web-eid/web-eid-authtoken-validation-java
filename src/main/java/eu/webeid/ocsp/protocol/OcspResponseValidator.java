...
public final class OcspResponseValidator {
    ...
    public static void validateSubjectCertificateStatus(SingleResp certStatusResponse, URI ocspResponderUri)
            throws UserCertificateRevokedException, UserCertificateOCSPCheckFailedException {
        ...
        if (status instanceof RevokedStatus revokedStatus) {
            ...
            throw new UserCertificateOCSPCheckFailedException("Unknown status", ocspResponderUri);
        } else {
            throw new UserCertificateOCSPCheckFailedException("Status is neither good, revoked nor unknown", ocspResponderUri);
        }
    }
