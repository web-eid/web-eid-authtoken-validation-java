...
class CertificateDataTest {
    ...
    void whenOrganizationCertificate_thenSubjectCNAndIdCodeAndCountryCodeExtractionSucceeds() throws Exception {
        ...
        assertThat(CertificateData.getSubjectCN(organizationCert).get())
            .isEqualTo("Testijad.ee isikutuvastus");
        assertThat(CertificateData.getSubjectIdCode(organizationCert).get())
            .isEqualTo("12276279");
        assertThat(CertificateData.getSubjectCountryCode(organizationCert).get())
            .isEqualTo("EE");
    }
